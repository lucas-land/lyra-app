...
export const NOTICIAS: Noticia[] = [
  {
    ...
    descricao:
      `Tradição que atravessa gerações em Estância Velha.

A Sociedade Canto Lyra comemorou recentemente 79 anos de história...`,
    data: '01/03/2026',
    conteudo:
    `Tradição que atravessa gerações em Estância Velha.

A Sociedade Canto Lyra comemorou recentemente 79 anos de história, sendo um dos clubes mais tradicionais da região e um importante espaço de convivência para a comunidade.

O clube é conhecido pela forte presença no bolão, esporte que faz parte da identidade da entidade e que ao longo dos anos rendeu importantes conquistas em competições estaduais.

Mas a estrutura da Sociedade Canto Lyra vai muito além do esporte. O espaço conta com quadra esportiva, quadra de areia, piscinas, áreas para churrasco e um amplo ambiente para festas e eventos, reunindo famílias, associados e visitantes.

A história continua sendo construída. Em março de 2026, o clube será sede da 4ª Copa RS de Bolão Masculino Bola 23, competição que deve reunir equipes de várias regiões do estado.`,
  },
  {
    id: 2,
    ...
    descricao:
      'No último sábado, 5 de julho, o Departamento de Bolão da Sociedade de Canto Lyra realizou a primeira edição do Torneio Aberto de Quintetos do Lyra...',
    data: '07/03/2026',
    conteudo:
      `No último sábado, 5 de julho, o Departamento de Bolão da Sociedade de Canto Lyra realizou a primeira edição do Torneio Aberto de Quintetos do Lyra, reunindo 29 equipes inscritas de diversas cidades do Vale do Sinos, Encosta da Serra, Serra, Vale do Caí e região, como Garibaldi, Nova Petrópolis, Imigrante, Montenegro, Bento Gonçalves, Caxias do Sul e diversos outros municípios da região.

A competição movimentou as dependências do clube durante todo o dia, reunindo atletas, famílias e simpatizantes do bolão em uma jornada de integração entre clubes e fortalecimento da modalidade na região.

Classificação Final:
🥇 1º lugar: Sociedade Recreativa Ipiranga, de São Leopoldo
🥈 2º lugar: Clube do Comécio, de Montenegro
🥉 3º lugar: ASUAC Bom Progresso A, de Bom Princípio
4️⃣ 4º lugar: Sociedade Juvenil de Linha Temerária, de Nova Petrópolis
5️⃣ 5º lugar: ASUAC Bom Progresso B, de Bom Princípio
6️⃣ 6º lugar: Sociedade Atiradores Dois Irmãos - SADI, de Dois Irmãos.

Premiação Individual Geral:
💪🏻🏅 Braço de Ouro: Inácio da Sociedade Recreativa Ipiranga, com 359 pinos.
💪🏻🥈 Braço de Prata: Marcelino da Assoc. Bom Progresso, com 356 pinos.
💪🏻🥉 Braço de Bronze: Caio da Sociedade Juvenil, com 355 pinos.

O Departamento de Bolão da Sociedade de Canto Lyra agradece, de coração, a cada equipe que se inscreveu e abraçou nosso torneio, e também a todos da equipe de trabalho que, com dedicação e parceria, tornaram este evento possível. Obrigado! 💚`,
  },
  {
    id: 3,
    ...
    descricao:
      `A temporada de piscinas está chegando ao fim...`,
    data: '10/03/2026',
    conteudo:
      `Últimos dias de temporada!
A temporada de piscinas está chegando ao fim, mas ainda dá tempo de aproveitar o calor e dar aqueles últimos mergulhos! 😎🏊‍♂️
📅 As piscinas estarão abertas até o dia 15/03 (domingo).
Reúna a família, chame os amigos e venha curtir esses últimos dias de verão no clube!`
  },
];
